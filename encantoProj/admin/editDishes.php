<?php 
    ...
    include './methods/save_edits_dishes.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <h1>EDITE AS INFORMAÇÕES DO PRATO</h1>
    ...
    <div class="login-container">
        ...
        <form enctype="multipart/form-data" action="" method="POST">
            ...
            <input type="text" id="nameDishe" name="nameDishe" value="<?php echo $nameDishe?>"
                placeholder="Digite o nome do Prato" required>

            <label for="descDishe">Descrição do Prato</label>
            <input type="text" id="descDishe" name="descDishe" value="<?php echo $descDishe?>"
                placeholder="Digite a descrição do Prato" required>

            <div id="priceDiv">
                <label for="priceDishe">Digite o preço do Prato </label>
                <input id="inputNumber" type="number" step="0.01" value="<?php echo $priceDishe?>" id="priceDishe"
                    name="priceDishe" placeholder="Digite o preço do Prato" required>
            </div>
